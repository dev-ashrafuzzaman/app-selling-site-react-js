...
export const router = createBrowserRouter([
    ...
    },
    {
        ...
        element: <PrivateRoute><WebDashboard></WebDashboard></PrivateRoute>,
        children: [
            {
                path: 'home',
                element: <PrivateRoute><WebHome></WebHome></PrivateRoute>
            },
            {
                path: 'user-inbox',
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`${import.meta.env.VITE_BASE_URL}/api/v1/web/user/direct-link/${params.id}`)
            },
            {
                path: 'visit-earn',
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`${import.meta.env.VITE_BASE_URL}/api/v1/web/user/visit-earn/${params.id}`)
            },
            {
                path: 'withdraw-type',
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`${import.meta.env.VITE_BASE_URL}/api/v1/public/user/${params.id}`)
            },
            {
                path: 'track-user/:id',
                element: <TrackCustomer></TrackCustomer>,
                loader: ({ params }) => fetch(`${import.meta.env.VITE_BASE_URL}/api/v1/public/track/user/${params.id}`)
