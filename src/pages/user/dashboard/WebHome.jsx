    ...
    <div className="my-6">
      <div className="border-2 w-full  my-2 flex justify-start items-center gap-2">
        ...
        <div className="text-red-600 w-full">
          <Marquee className="h-12">{isWebUser?.global?.topNews}</Marquee>
        </div>
      </div>
      <div className="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-3 my-4">
        <div className="flex justify-between items-center bg-white p-4 rounded-2xl drop-shadow-xl">
          <div>
            ...
            <p className="font-extrabold text-3xl">
              {parseInt(isWebUser?.user?.balance)} {softInfo.currency}
            </p>
          </div>
          <div
            onClick={() => refetch()}
            className={`bg-gradient-to-r ${softInfo.adminStat}  p-6 rounded-2xl text-white text-xl tooltip`}
            data-tip={"Refresh"}>
            <MdWallet></MdWallet>
          </div>
        </div>
        <div className="flex justify-between items-center bg-white p-4 rounded-2xl drop-shadow-xl">
          ...
          <div
            className={`bg-gradient-to-r ${softInfo.adminStat}  p-6 rounded-2xl text-white text-xl`}>
            <FaUser></FaUser>
          </div>
        </div>
        <div className="flex justify-between items-center bg-white p-4 rounded-2xl drop-shadow-xl">
