        ...
        <tr className='border-2 hover:bg-slate-100'>
            ...
            <td className='border-2'>
                <div className="font-semibold">
                    <a className="text-sky-600 font-bold cursor-pointer" href={`/leery/admin/dashboard/track-user/${user?._id}`} target="_blank">Phone: {user?.phone}</a>
            ...
            <td className='border-2'>
                <div className="font-semibold">
                    ...
                    <p className="font-bold">Final Amounts: {parseFloat(data?.outAmount) + parseFloat(global?.withdrawRules?.outAmount)}</p>
                </div>
            </td>
